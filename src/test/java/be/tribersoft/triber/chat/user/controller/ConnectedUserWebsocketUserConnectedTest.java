...
public class ConnectedUserWebsocketUserConnectedTest {
	...
	public void shouldBroadcast() {
		connectedUserWebsocket.userConnected(user);

		verify(webSocketService).send(eq("/topic/user/connected"), userToJsonAdapterCaptor.capture());
