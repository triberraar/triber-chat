...
public class DefaultConnectedUserListenerUserConnectedTest {
	...
	@Test
	public void addsUserToConnectedUsersRepository() {
		defaultConnectedUserListener.userConnected(user);
